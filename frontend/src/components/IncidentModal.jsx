...
import { INCIDENT_TYPES, GUILTY_PARTIES, STATUSES, PRIORITIES } from '../api/constants'
      ...
      <div className="modal">
        <div className="modal-header">
          <div className="modal-title">
            {incident?.id ? 'Редактировать инцидент' : 'Новый инцидент'}
          </div>
            ...
            <div className="form-grid cols-1" style={{gap:12}}>
              ...
              <div className="field">
                ...
                <textarea value={form.guard_response}
                  ...
                  placeholder="Как отреагировал департамент охраны?" style={{minHeight:60}} />
              </div>
              <div className="field">
                <label>Причина</label>
              ...
              <div className="field">
                ...
                <textarea value={form.resolution}
                  ...
                  placeholder="Принятые меры" style={{minHeight:60}} />
              </div>
              <div className="field">
